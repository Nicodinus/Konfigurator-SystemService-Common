...
namespace Konfigurator\SystemService\Common\Network\Packet\Actions\FileTransfer\Response;
...
class EventPacket extends FileTransferPacket
{
    ...
    {
        return "file_transfer.response.status";
    }
    ...
    protected function handleSuccess(): Promise
    {
        return call(static function (self &$self) {
            try {
                return yield FileTransferService::getInstance()->handleResponse($self);
            } catch (\Throwable $e) {
